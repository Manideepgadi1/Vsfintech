...
# PMS Screener Deployment Script
# Deploy fundscreener (PMS Screener) Flask application on VPS
# Port: 3003
# Server: 82.25.105.18

set -e  # Exit on error

echo "🚀 PMS Screener Deployment Script"
echo "=================================="
echo ""

# Configuration
APP_NAME="pms-screener"
APP_DIR="/var/www/vsfintech/fundscreener"
PORT=3003
...
if [ ! -d "$APP_DIR" ]; then
    ...
    echo "Please upload your fundscreener code to $APP_DIR first"
    exit 1
fi
...
# Create Nginx configuration for PMS Screener
...
# Test through Nginx
HTTP_CODE_NGINX=$(curl -s -o /dev/null -w "%{http_code}" http://localhost/pms-screener/ || echo "000")
...
echo ""
echo "=================================="
echo -e "${GREEN}🎉 PMS Screener Deployment Complete!${NC}"
echo "=================================="
echo ""
...
echo "  - Via Nginx: http://82.25.105.18/pms-screener/"
echo ""
